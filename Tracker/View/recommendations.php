...
<link rel="stylesheet" type="text/css" href="css/material.css" />
	...
	<body>
		<?php
            ...
            $type = $_GET['type'];
			$json1 = file_get_contents("{$GLOBALS["ip"]}index.php?type=films&recommendations=$id");
            $json2 = file_get_contents("{$GLOBALS["ip"]}index.php?type=tv_shows&recommendations=$id");
        ...
        <?php //include_once('View/navbar.php');?>
            ...
            foreach($obj2['tv_shows'] as $show){
				echo "<div class='image'>";
				echo "<a href='{$GLOBALS["ip"]}View/getShow.php?type=films&season=1&id=" . $show['id'] . "'>";
